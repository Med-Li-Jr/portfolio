...
export class AppComponent implements OnInit {
  ...
  changeLinkState() {
    ...
    window.onscroll = function () { 
      ...
      console.log(mainThis.sections[index])
      // if(mainThis.sections[index])
      {

        while (--index && scrollTop + 115 < mainThis.sections[index].offsetTop) { }
  ...
  //     let index = mainThis.sections.length;
  //     let scrollTop = document.documentElement.scrollTop ?? 0
  //     console.log(mainThis.sections.length)
  //     if (mainThis.sections[index]) {

  //       console.log(mainThis.sections[index].offsetTop, scrollTop)
